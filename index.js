pdfjsLib.GlobalWorkerOptions.workerSrc = 'https://cdnjs.cloudflare.com/ajax/libs/pdf.js/3.11.174/pdf.worker.min.js';
        ...
        const translations = {
            vi: {
                ...
                dropOverlayTitle: "Thả file để mở",
                dropOverlayHint: "TXT, MD, JSON, DOCX hoặc PDF",
            ...
            en: {
                ...
                dropOverlayTitle: "Drop file to open",
                dropOverlayHint: "TXT, MD, JSON, DOCX or PDF",
        ...
        function applyTranslations() {
            ...
            const dropOverlayTitle = document.getElementById('drop-overlay-title');
            const dropOverlayHint = document.getElementById('drop-overlay-hint');
            if (dropOverlayTitle) dropOverlayTitle.innerText = t.dropOverlayTitle;
            if (dropOverlayHint) dropOverlayHint.innerText = t.dropOverlayHint;
        ...
        // Kéo file ở BẤT KỲ ĐÂU trên trang -> hiện overlay toàn màn hình.
        // Cách này giống trải nghiệm kéo file vào các ứng dụng web hiện đại.
        ...
        document.addEventListener('dragleave', (e) => {
            ...
            if (globalDragDepth === 0) hideGlobalDropOverlay();
        });
        ...
        // Nếu người dùng kéo file ra khỏi cửa sổ trình duyệt.
